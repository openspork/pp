...
class ClientCert(Cert):
    ...
    # TODO: Check this works -- remove backref
    # This attribute maintains phone, even after cert is no longer active
    # Can be null, in case phone is deleted
    phone = ForeignKeyField(Phone, null=True) 
